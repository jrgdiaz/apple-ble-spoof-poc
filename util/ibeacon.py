...
from scapy.fields import ByteEnumField, LenField, PacketListField, \
    ShortField, SignedByteField, UUIDField, XByteField, IntEnumField
...
class AirPods_Data(Packet):
        """
        AirPods Broadcast data frame
        """
        name = "AirPods data"
        fields_desc = []
...
#bind_layers(Apple_BLE_Submessage, AirPods_Data, subtype=7)
